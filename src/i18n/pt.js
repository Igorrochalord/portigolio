// Conteúdo em português — fonte da verdade original. Edite aqui pra mudar textos/dados em PT.
...
export default {
  ui: {
    ...
    dashboard: {
      ...
      heading: "Métricas de infraestrutura, em tempo real",
      cloudCost: { title: "Cloud Cost Savings", legendSavings: "Economia", legendCurrent: "Custo atual" },
      deployTime: { title: "Deploy Time (min)" },
      automations: { title: "Automações Ativas" },
    },
    impact: {
      eyebrow: "IMPACTO PROFISSIONAL",
      heading: "Resultados, não apenas cargos",
    },
    automation: {
      eyebrow: "DADOS PÚBLICOS EM ESCALA",
      heading: "Automação e coleta de dados do governo, em produção",
      subheading: "Scrapers, pipelines e streaming em tempo real que sustentam o jornalismo de dados do Poder360.",
      scrapersByCategory: {
        title: "Scrapers por categoria",
        badge: "191 ativos",
        caption: "Em tempo real: notícias, agências públicas, dados econômicos (Bacen), mercado de ações (CVM) e mais",
      },
      sseLoadTest: {
        title: "Teste de carga — Gateway SSE (eleições)",
        badge: "200K conexões",
        caption: "Conexões simultâneas suportadas, por degrau de carga",
        tooltipLabel: "conexões",
        tooltipName: "Carga",
      },
    },
    github: {
      eyebrow: "DEPLOY ACTIVITY",
      liveBadge: "AO VIVO — via GitHub API",
      heading: "Este site também é CI/CD",
      viewOnGithub: "Ver no GitHub",
      errorPrefix: "Não consegui carregar os dados ao vivo agora. Veja direto em",
      loading: "Carregando atividade do GitHub…",
      durationCaption: "Duração dos últimos deploys (segundos)",
      tooltipDurationLabel: "Duração",
    ...
    projects: {
      eyebrow: "PROJETOS",
      heading: "Produtos que construí no Poder360",
      subheading:
        "Sistemas de dados públicos em produção, do backend de coleta ao streaming em tempo real — cada um com o resultado real que gerou.",
      personalHeading: "Projetos pessoais",
      personalSubheading: "Fora do horário de trabalho, sem métricas de produção.",
    },
    timeline: {
      eyebrow: "TRAJETÓRIA",
    ...
    testimonials: {
      ...
      subheading: "Recomendações reais recebidas no LinkedIn.",
      translatedNote: "Traduzido do português",
    },
    contact: {
      eyebrow: "VAMOS CONVERSAR",
      heading: "Aberto a oportunidades Backend / DevOps",
      subheading: (name, role, location) => `${name} — ${role}, ${location}. Vamos falar sobre o próximo desafio.`,
      whatsapp: "WhatsApp",
      email: "E-mail",
      linkedin: "LinkedIn",
      github: "GitHub",
    ...
    dedication: {
      eyebrow: "EM MEMÓRIA",
      helpTitle: "Você não precisa passar por isso sozinho",
      cvvLabel: "CVV — cvv.org.br · 188",
    },
    footer: {
      rights: (year, name) => `© ${year} ${name}. Todos os direitos reservados.`,
    },
    langToggle: {
      label: "EN",
