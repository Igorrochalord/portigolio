...
import { dedication, profile, maleSuicideIntro, maleSuicideStats, maleSuicideSource } from "../content.js";
    ...
    <section id="dedicatoria" className="px-6 py-24 border-t border-white/5">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <p className="font-mono text-amber-400/80 text-sm mb-2 tracking-widest">EM MEMÓRIA</p>
        ...
        >
          <div className="flex items-center gap-2 justify-start sm:justify-center mb-3">
            ...
            <p className="text-white font-semibold text-sm">Você não precisa passar por isso sozinho</p>
          </div>
